...
if($sql->rowCount() === 0) { // se email for igual a zero ele irar executar o cadastro se caso ele seja repetido ele não executa
   ...
   $sql = $pdo->prepare("INSERT INTO usuarios (nome, data_nascimento,data_cadastramento,cpf,email,endereco,telefone,modalidade)
   VALUES (:name,:data_nascimento,:data_cadastramento,:cpf,:email,:endereco,:telefone,:modalidade)");
